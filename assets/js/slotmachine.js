...
$(document).ready(function(){
  var slotImages = [
    "assets/img/slotmachine/one.gif",
    "assets/img/slotmachine/two.png",
    "assets/img/slotmachine/three.png",
    "assets/img/slotmachine/four.gif",
    "assets/img/slotmachine/five.png",
    "assets/img/slotmachine/six.png",
    "assets/img/slotmachine/seven.png"
  ];
